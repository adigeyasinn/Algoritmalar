...
public class DbVeriMerkezi {
    ...
    protected double elektrikFaturasi,suFaturasi,doğalgazFaturasi,internetFaturasi;
    ...
    public double getDoğalgazFaturasi() {
        return doğalgazFaturasi;
    }

    public void setDoğalgazFaturasi(double doğalgazFaturasi) {
        this.doğalgazFaturasi = doğalgazFaturasi;
    }
